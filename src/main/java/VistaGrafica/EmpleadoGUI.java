...
public class EmpleadoGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        salarioInput = new javax.swing.JTextPane();
        label4 = new java.awt.Label();
        jScrollPane4 = new javax.swing.JScrollPane();
        idCargoInput = new javax.swing.JTextPane();
        ...
        jScrollPane2.setViewportView(salarioInput);

        label4.setText("id cargo:");

        jScrollPane4.setViewportView(idCargoInput);

        jScrollPane5.setViewportView(idPersonaInput);

        label5.setText("id persona:");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "salario", "id cargo", "id persona"
            }
        ) {
    ...
    private void listarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listarBtnActionPerformed
        ...
        for (Empleado empleado : empleados) {
            model.addRow(new Object[]{empleado.getId(), empleado.getCargo().getId(), empleado.getSalario(), empleado.getPersona()}); 
        }
    ...
    private void eliminarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarBtnActionPerformed
        ...
        String idEmpleadoText = idInput.getText();
    ...
    private void editarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarBtnActionPerformed
        ...
        String idEmpleadoText = idInput.getText();
        String salarioText = salarioInput.getText();
        String idPersonaText = idPersonaInput.getText();
        String idCargoText = idCargoInput.getText();
        
        if (idPersonaText.isEmpty() || salarioText.isEmpty() || idPersonaText.isEmpty() || idCargoText.isEmpty()) {
        ...
        int idCargo = Integer.parseInt(idCargoText);
    ...
    private javax.swing.JTextPane idCargoInput;
    ...
    private javax.swing.JTextPane salarioInput;
